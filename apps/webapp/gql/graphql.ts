...
export type GetPoolsQuery = {
  ...
  uniswapV3Pools: Array<{
    ...
    blocks: Array<{
      __typename?: "PoolBlock"
      block?: { __typename?: "BlockInfo"; id: number; timestamp: number } | null
    }>
  }>
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "uniswapV3Pools" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getPoolInfo" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "uniswapV3Pool" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
...
} as unknown as DocumentNode<GetPoolInfoQuery, GetPoolInfoQueryVariables>
