"use strict";var __getProtoOf = Object.getPrototypeOf;
...
// src/env.ts
var _envcore = require('@t3-oss/env-core');


var _zod = require('zod');
var env = _envcore.createEnv.call(void 0, {
  server: {
    GOERLI_PROVIDER_URL: _zod.z.string().url(),
    GOERLI_PRIVATE_KEY: _zod.z.string().min(64).max(66),
    CALLBACK_ADDRESS: _zod.z.string().refine((value) => _viem.isAddress.call(void 0, value))
  },
  runtimeEnv: {
...
var _core = require('@axiom-crypto/core');
...
var _halo2js = require('@axiom-crypto/core/halo2-js');




var _js = require('@axiom-crypto/core/halo2-js/js');
...
// src/lib/axiom-v2/circuit/index.ts
var MyAxiomCircuit = class extends _js.CircuitScaffold {
  ...
  constructor(provider, myCircuitCode) {
    ...
    this.provider = new _ethers.ethers.JsonRpcProvider(provider);
    this.config = _halo2js.DEFAULT_CIRCUIT_CONFIG;
  ...
  setup() {
    return __async(this, null, function* () {
      this.halo2wasm = yield _js.getHalo2Wasm.call(void 0, 0);
      __superGet(MyAxiomCircuit.prototype, this, "newCircuitFromConfig").call(this, this.config);
      if (this.halo2Lib)
        this.halo2Lib.free();
      this.halo2Lib = _js.getHalo2LibWasm.call(void 0, this.halo2wasm);
    });
  }
  ...
  tune() {
    return __async(this, null, function* () {
      _halo2js.autoConfigCircuit.call(void 0, this.halo2wasm, this.config);
    });
  }
  ...
  build(defaultInputs2) {
    return __async(this, null, function* () {
      const { results } = yield _halo2js.AxiomCircuitRunner.call(void 0, 
        this.halo2wasm,
        this.halo2Lib,
        this.config,
        this.provider
      ...
      const { numUserInstances } = yield _halo2js.AxiomCircuitRunner.call(void 0, 
        this.halo2wasm,
        this.halo2Lib,
        this.config,
        this.provider
  ...
  run(inputs) {
    return __async(this, null, function* () {
      const runner = _halo2js.AxiomCircuitRunner.call(void 0, 
        this.halo2wasm,
        this.halo2Lib,
        this.config,
        this.provider
  ...
  getQuerySchema() {
    ...
    const packed = _ethers.solidityPacked.call(void 0, 
      ["uint8", "uint16", "uint8", "bytes32[]"],
      [this.config.k, this.resultLen, vk.length, vk]
    );
    return _ethers.keccak256.call(void 0, packed);
  }
  getComputeProof() {
...
function generateQuery(loadedCircuit, poolBlockNumber, poolAddress, callbackAddr) {
  return __async(this, null, function* () {
    const callback = {
      target: callbackAddr,
      extraData: _core.bytes32.call(void 0, 0)
    };
    const input = {
      poolBlockNumber,
      poolAddress
  ...
  return __async(this, null, function* () {
    try {
      const client = _viem.createPublicClient.call(void 0, {
        chain: _chains.goerli,
        transport: _viem.http.call(void 0, env.GOERLI_PROVIDER_URL)
      });
...
// src/cron-jobs/axiom-query/send-axiom-query.ts
var jobSendAxiomQuery = new (0, _cron.CronJob)(
  "0 */30 * * * *",
  // cronTime
  function() {
    return __async(this, null, function* () {
