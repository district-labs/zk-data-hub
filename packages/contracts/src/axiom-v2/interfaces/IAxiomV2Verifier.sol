...
interface IAxiomV2Verifier {
    ...
    /// @notice Verify the blockhash of block blockNumber equals claimedBlockHash. Assumes that blockNumber is within
    /// the last 256 most recent blocks.
    ...
    /// @notice Verify the blockhash of block witness.blockNumber equals witness.claimedBlockHash by checking against
    /// Axiom's cache of #historicalRoots.
    ...
    ///         witness.prevHash is the prevHash stored in #historicalRoots(witness.blockNumber - witness.blockNumber %
    /// 1024)
    ///         witness.numFinal is the numFinal stored in #historicalRoots(witness.blockNumber - witness.blockNumber %
    /// 1024)
    ///         witness.merkleProof is the Merkle inclusion proof of witness.claimedBlockHash to the root stored in
    /// #historicalRoots(witness.blockNumber - witness.blockNumber % 1024)
